...
Create a document called \qu{modeling\_essay\_proposal.txt} (could be in any raw text format e.g. txt, md, tex/PDF) and push to your repository under the folder \qu{writing\_assignments}. 
...
\noindent To create the \qu{PDF with tracked changes} for
...
An introduction of no more than 1.5 pages that talks about the phenomenon, why you are modeling it why it is important and a short history of attempts to model it.
...
Description of how the prediction target is measured exactly 
Discuss if you believe this measurement can be made accurately
...
A discussion of how can supervised learning be used to model your phenomenon
...
Definition of the model section problem and how it arises during modeling.
...
Do you have enough sample in your historical data to fit this selected model? Discuss.
Define underfitting.
